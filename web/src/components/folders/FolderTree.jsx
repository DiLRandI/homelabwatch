    ...
    <div className="space-y-2">
      ...
      >
        ...
        <div className="flex items-center gap-1">
          <button
            className="rounded-lg p-2 text-copy-subtle transition hover:bg-base hover:text-ink disabled:opacity-50"
            disabled={!canManage}
          ...
          <button
            className="rounded-lg p-2 text-copy-subtle transition hover:bg-danger/10 hover:text-danger-strong disabled:opacity-50"
            disabled={!canManage}
...
export default function FolderTree({
  ...
  return (
    <section className="space-y-4">
      ...
      >
        <span>
          <span className="block text-sm font-medium text-ink">All bookmarks</span>
          <span className="mt-1 block text-xs text-muted">Across every folder</span>
        </span>
      </button>

      <div className="space-y-2">
        {folders.length === 0 ? (
          <div className="rounded-lg border border-dashed border-line bg-panel-strong px-4 py-5 text-sm text-muted">
