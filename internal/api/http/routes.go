...
func (r *Router) registerUIRoutes(mux *http.ServeMux) {
	openRoutes := []routeSpec{
		...
		{method: http.MethodGet, path: "/api/ui/v1/discovery/topology-sources", handler: r.handleTopologySources},
	...
	trustedRoutes := []routeSpec{
		...
		{method: http.MethodPost, path: "/api/ui/v1/discovery/topology-sources", handler: r.handleTopologySources},
		{method: http.MethodPatch, path: "/api/ui/v1/discovery/topology-sources/{id}", handler: r.handleTopologySourceByID},
		{method: http.MethodDelete, path: "/api/ui/v1/discovery/topology-sources/{id}", handler: r.handleTopologySourceByID},
		{method: http.MethodPost, path: "/api/ui/v1/discovery/topology/auto-discover", handler: r.handleTopologyAutoDiscover},
		{method: http.MethodPost, path: "/api/ui/v1/discovery/topology/run", handler: r.handleTopologyDiscoveryRun},
...
func (r *Router) registerTokenRoutes(mux *http.ServeMux, prefix string) {
	routes := []routeSpec{
		...
		{method: http.MethodGet, path: "/discovery/topology-sources", scope: domain.TokenScopeRead, handler: r.handleTopologySources},
		{method: http.MethodPost, path: "/discovery/topology-sources", scope: domain.TokenScopeWrite, handler: r.handleTopologySources},
		{method: http.MethodPatch, path: "/discovery/topology-sources/{id}", scope: domain.TokenScopeWrite, handler: r.handleTopologySourceByID},
		{method: http.MethodDelete, path: "/discovery/topology-sources/{id}", scope: domain.TokenScopeWrite, handler: r.handleTopologySourceByID},
		{method: http.MethodPost, path: "/discovery/topology/auto-discover", scope: domain.TokenScopeWrite, handler: r.handleTopologyAutoDiscover},
		{method: http.MethodPost, path: "/discovery/topology/run", scope: domain.TokenScopeWrite, handler: r.handleTopologyDiscoveryRun},
